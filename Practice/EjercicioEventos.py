...
def modificar_evento(data):
    ...
    for i in eventos:
        ...
        count += 1
        print(i)
    op = int(input("Numero del evento: "))
    new_name = input("Nuevo nombre: ")
    eventos[op - 1]["Nombre"] = new_name
    new_locacion = input("Nueva locacion: ")
    eventos[op-1]["Locacion"] = new_locacion
    new_dia = input("Nuevo dia: ")
    eventos[op-1]["Dia"] = new_dia
    print(eventos[op - 1])
